...
var WeatherService = /** @class */ (function () {
    ...
    WeatherService.prototype.JsonRequest = function (params, url) {
        var body = (params == null) ? "" : JSON.stringify(params);
        var headers = new http_1.Headers({ "Content-Type": "application/json" });
        var options = new http_1.RequestOptions({ headers: headers });
        return this.http.post(weather_1.settings.webApiUrl + "/WeatherHome/" +
    ...
    WeatherService.prototype.getCitiesByCountry = function (countryName) {
        return this.JsonRequest({ countryName: countryName }, "GetCitiesByCountry");
    };
    WeatherService.prototype.getWeather = function (cityName, countryName) {
